 ...
 */
final class Version20210330192120 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE podcast ADD currently_live INT NOT NULL, ADD currently_watching INT DEFAULT NULL, CHANGE podcast_source podcast_source VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE tag ADD tag_style VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE podcast DROP currently_live, DROP currently_watching, CHANGE podcast_source podcast_source VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE tag DROP tag_style');
