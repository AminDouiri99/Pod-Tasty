 ...
 */
final class Version20210226213810 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE podcast (id INT AUTO_INCREMENT NOT NULL, playlist_id_id INT NOT NULL, podcast_name VARCHAR(255) NOT NULL, podcast_description VARCHAR(255) DEFAULT NULL, podcast_image LONGBLOB DEFAULT NULL, podcast_genre VARCHAR(255) NOT NULL, podcast_views INT NOT NULL, podcast_date DATETIME NOT NULL, podcast_source LONGBLOB NOT NULL, INDEX IDX_D7E805BDDC588714 (playlist_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_info (id INT AUTO_INCREMENT NOT NULL, user_last_name VARCHAR(255) NOT NULL, user_first_name VARCHAR(255) NOT NULL, user_image LONGBLOB DEFAULT NULL, user_gender VARCHAR(255) NOT NULL, user_birth_date DATETIME NOT NULL, user_bio VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
